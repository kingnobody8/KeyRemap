...
/*HABIG EDIT*/
#ifdef SFML_OPENGL_ES			//Set SFML_OPENGL_ES preprocessor value to the version number if you want to use ES. Supports 1, 2, & 3.
	#define SFML_OPENGL_ES_VER SFML_OPENGL_ES
#else
	#define SFML_OPENGL_ES_VER 0
#endif

#if !defined(SFML_OPENGL_ES) || SFML_OPENGL_ES_VER == 1  //OpenGL ES 2.0 and greater cannot perform Fixed Function Pipeline.
	#define SFML_FIXED_FUNCTION true
#endif
