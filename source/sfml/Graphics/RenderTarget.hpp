...
#include <SFML/Graphics/Shader.hpp> /*HABIG EDIT*/
...
#include <vector> /*HABIG EDIT*/
#include <SFML/System/Vector4.hpp> /*HABIG EDIT*/
...
public:
    ...
    void draw(const Vertex* vertices, std::size_t vertexCount,
              PrimitiveType type, RenderStates states = RenderStates::Default);
...
private:
    ...
    ////////////////////////////////////////////////////////////
	/*HABIG EDIT*/
    void applyTexture(const Texture* texture, Shader* shader = nullptr);
	...
	struct VertexExp //expanded vertex (color is now float4, not packed int)
	{
		VertexExp() {}
		VertexExp(Vertex v)
			: position(v.position)
			, color(v.color.toVec4())
	...
	std::vector<VertexExp> m_vertexExpanded;
