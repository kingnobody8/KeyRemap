...
#include <glad/gl.h>
...
#ifdef SFML_OPENGL_ES /*HABIG EDIT*/

    #include <SFML/OpenGL.hpp>

	#if SFML_OPENGL_ES_VER == 1
		...
		// Core since 2.0 - OES_blend_subtract
		#define GLEXT_blend_subtract                      false
		...
		// Core since 2.0 - vertex_buffer_object
		...
		#define GLEXT_glDeleteProgramObject				  glDeleteProgram
		...
		#define GLEXT_glGetShaderiv						  glGetShaderiv
		#define GLEXT_glGetShaderInfoLog                  glGetShaderInfoLog
		#define GLEXT_glGetProgramiv					  glGetProgramiv
	...
	#endif
/*HABIG TODO make this work between opgl es versions*/
    //// SFML requires at a bare minimum OpenGL ES 1.0 capability
    //// Some extensions only incorporated by 2.0 are also required
    //// OpenGL ES 1.0 is defined relative to OpenGL 1.3
    //// OpenGL ES 1.1 is defined relative to OpenGL 1.5
...
/*HABIG EDIT*/
	...
	#define GLEXT_glDeleteProgramObject               glDeleteObjectARB
/*HABIG EDIT*/
	...
	#define GLEXT_glUniform1ui                        glUniform1ui
...
/*HABIG EDIT*/
    #define GLEXT_glGetShaderiv						  glGetObjectParameterivARB
    #define GLEXT_glGetShaderInfoLog                  glGetInfoLogARB
	#define GLEXT_glGetProgramiv					  glGetObjectParameterivARB
